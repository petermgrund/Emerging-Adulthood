...
df_analysis$exploration_bin <- df_analysis %>%
...
df_analysis$achievement <- df_analysis %>% 
  select(starts_with("moa1#2")|starts_with("moa2#2")) %>% 
...
levels(by_race$race) <- c("White", "Other race", "Hispanic/Latino", "Black", "Asian", "Native American")
  
scale_order <- c("White", "Other race", "Hispanic/Latino", "Black","Asian", "Native American")
